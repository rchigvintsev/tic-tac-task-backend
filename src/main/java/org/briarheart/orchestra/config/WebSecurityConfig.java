        ...
        return http.cors().configurationSource(createCorsConfigurationSource())
                .and()
                    ...
                    .authorizeExchange()
                        ...
                        .pathMatchers(HttpMethod.POST, "/users/*/email/confirmation/*").access(unauthenticated())
                        .pathMatchers(HttpMethod.POST, "/users/password/reset").access(unauthenticated())
                        .pathMatchers(HttpMethod.POST, "/users/*/password/reset/confirmation/*").access(unauthenticated())
